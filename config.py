...
responses = [
	"Сорр, щас занят",
	"Можешь пока зайти в чат, там конкурсы, ворк, всякое [https://t.me/t0rtuga_chat]({invite_link})"
...
message_ids = [44, 46, 47, 48, 49] # [22, 23, 25, 31, 40, 42, 43, 44, 45]
per_chat_ids = {
